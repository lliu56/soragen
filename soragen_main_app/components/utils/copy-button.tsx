...
const CopyButton: React.FC<CopyButtonProps> = ({ textToCopy }) => {
  ...
  return (
    <div className="flex justify-end items-center">
      ...
      {/* Only the SVG icon is the button */}
      <button
        onClick={handleCopy}
        title="Copy to clipboard"
        className="hover:scale-105 focus:outline-none active:scale-95 transition duration-150 ease-in-out h-3 w-3 opacity-20 hover:opacity-50"
      ...
      >
        ...
        <svg
          ...
          className="h-6 w-6" // Tailwind CSS sizing classes
        >
          {/* SVG paths */}
          <path
